...
namespace GRS.Data.Model.Extensions
{
   ...
   public static class Cast
   {
      ...
      /// </summary>
      /// <typeparam name="T">
      /// typeparam is the type in which value will be returned, it could be any type eg. int,
      /// string, bool, decimal etc.
      /// </typeparam>
      /// <param name="input">
      /// Input that need to be converted to specified type
      /// </param>
      /// <param name="defaultValue">
      /// defaultValue will be returned in case of value is null or any exception occures
      /// </param>
      /// <returns>
      /// Input is converted in Type of default value or given as typeparam T and returned
      /// </returns>
      public static T To<T>(object input, T defaultValue)
      {
         ...
         {
            log.Error($"Cast.To for '{typeof(T).Name}'", ex);
            throw;
         }
